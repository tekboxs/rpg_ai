...
def start_client():
    ...
    try:
        ...
        print("\n🎮 Conectado ao RPG!")
        print("\n💡 **SISTEMA SIMPLIFICADO - COMANDOS DISPONÍVEIS:**")
        print("**📝 Comandos Principais:**")
        print("- {fazer <ação>} - Adiciona ação à fila")
        print("- {dizer <fala>} - Adiciona fala à fila")
        print("- {historia <elemento>} - Adiciona elemento narrativo à fila")
        print("- {mestre} - Processa todas as ações em fila")
        print("\n**🔧 Comandos Auxiliares:**")
        print("- {status} - Mostra status e da fila")
        ...
        print("\n**💡 Como Funciona:**")
        print("1. Use {fazer}, {dizer} ou {historia} para suas ações")
        print("2. Todas ficam em fila até usar {mestre}")
        print("3. O {mestre} processa tudo e gera nova cena")
        print("4. Você tem controle total sobre a narrativa!")
        print("\n**🎭 Exemplos:**")
        print("- {fazer investigar a mesa em busca de pistas}")
        print("- {dizer \"Olá, posso ajudá-lo?\"}")
        print("- {historia uma tempestade se aproxima}")
        print("- {mestre}")
